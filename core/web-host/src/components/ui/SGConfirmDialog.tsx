      ...
      >
        ...
        <div className="px-6 pb-6 flex gap-3 justify-end">
          ...
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className={`px-6 py-2.5 rounded-xl font-black text-[13px] text-white shadow-lg transition-all flex items-center gap-2 
              ${isLoading ? 'opacity-60 cursor-not-allowed' : `${styles.btn} hover:-translate-y-0.5`}
            `}
          >
