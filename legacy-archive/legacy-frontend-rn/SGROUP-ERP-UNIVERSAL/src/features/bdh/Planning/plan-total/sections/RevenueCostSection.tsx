  ...
  return (
    <>
      <View style={cardStyle}>
        <SGPlanningSectionTitle icon={PieChart} title="1. Bảng Doanh thu & Chi phí" accent="#2563EB" />
        ...
        >
          <View style={{ flex: 1, minWidth: isMobile ? 0 : 320, alignItems: 'center', paddingVertical: 18 }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'baseline', gap: 8 }}>
              ...
              />
              <Text style={{ fontSize: isMobile ? 18 : 28, fontWeight: '900', color: '#94A3B8' }}>Tỷ</Text>
            </View>
          </View>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <View style={{ minWidth: isMobile ? 960 : 0 }}>
              <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 14, backgroundColor: soft }}>
                <Text style={{ flex: 1.7, color: text3, fontSize: 10, fontWeight: '900', letterSpacing: 1.8 }}>BIẾN PHÍ VẬN HÀNH</Text>
                <Text style={{ width: 110, textAlign: 'center', color: '#4F46E5', fontSize: 10, fontWeight: '900' }}>% / DOANH THU</Text>
                <Text style={{ width: 110, textAlign: 'center', color: text3, fontSize: 10, fontWeight: '900' }}>% / DOANH SỐ</Text>
                <Text style={{ width: 130, textAlign: 'right', color: '#2563EB', fontSize: 10, fontWeight: '900' }}>GIÁ TRỊ</Text>
                <Text style={{ width: 130, textAlign: 'right', color: '#7C3AED', fontSize: 10, fontWeight: '900' }}>TRIỆU / GD</Text>
              </View>
                ...
                return (
                  ...
                  >
                    ...
                    <Text style={{ width: 130, textAlign: 'right', color: '#2563EB', fontSize: 18, fontWeight: '900' }}>
                      {fmt(mappedValue)} <Text style={{ fontSize: 10, color: text3 }}>Tỷ</Text>
                    </Text>
              ...
              >
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <Text style={{ flex: 1.7, color: '#FFFFFF', fontWeight: '900', fontSize: 18 }}>Tổng Biến Phí</Text>
                  ...
                  <Text style={{ width: 130, textAlign: 'right', color: '#FFFFFF', fontWeight: '900', fontSize: 18 }}>
                    {fmt(metrics.totalCostInhouse)} Tỷ
                  </Text>
      ...
      >
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap', alignItems: 'center' }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 18 }}>
            ...
            <View>
              <Text style={{ color: '#A5B4FC', fontSize: 11, fontWeight: '900', letterSpacing: 2.4, marginBottom: 8 }}>LỢI NHUẬN GỘP (GP)</Text>
              <View style={{ flexDirection: 'row', gap: 10, flexWrap: 'wrap' }}>
                <View style={{ paddingHorizontal: 14, paddingVertical: 8, borderRadius: 14, backgroundColor: 'rgba(99,102,241,0.2)' }}>
                  <Text style={{ color: '#C7D2FE', fontSize: 12, fontWeight: '800' }}>
                    % Doanh thu còn lại: <Text style={{ color: '#FFFFFF' }}>{fmt(metrics.gpPctRevenue, 1)}%</Text>
                  </Text>
                </View>
                <View style={{ paddingHorizontal: 14, paddingVertical: 8, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.12)' }}>
                  <Text style={{ color: '#C7D2FE', fontSize: 12, fontWeight: '800' }}>
                    % Doanh số còn lại: <Text style={{ color: '#FFFFFF' }}>{fmt(metrics.avgNetFeePct, 2)}%</Text>
                  </Text>
                </View>
              </View>
            </View>
          ...
          <View style={{ alignItems: 'flex-end' }}>
            ...
            <Text style={{ color: '#A5B4FC', fontSize: isMobile ? 14 : 18, fontWeight: '900', letterSpacing: 2 }}>TỶ VNĐ</Text>
          </View>
        </View>
      </LinearGradient>
    </>
