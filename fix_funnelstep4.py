...
import re
# Remove ALL corrupted blocks
c = re.sub(r'function FunnelStep\(\{.*?\n\}\n', '', c, flags=re.DOTALL)
c = re.sub(r'function DownArrow\(\) \{.*?\n\}\n', '', c, flags=re.DOTALL)

# Insert the perfect one once right before function NumberField
c = c.replace('function NumberField(', new_funnel_step + '\n\nfunction NumberField(')
